-- AlterTable: Add new columns to bookings table
...
-- AlterTable: Make clientId and serviceId nullable
...
-- AlterTable: Add booking-related fields to instructor_profiles
...
-- CreateTable: availability (weekly schedule)
...
-- CreateTable: availability_exceptions (special dates)
