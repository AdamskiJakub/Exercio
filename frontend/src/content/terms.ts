...
3. [Charakter platformy — marketplace](#3-charakter-platformy--marketplace)
4. [Zasady korzystania z Platformy](#4-zasady-korzystania-z-platformy)
5. [Rejestracja i konto](#5-rejestracja-i-konto)
6. [Role użytkowników](#6-role-użytkowników)
7. [Profile instruktorów i firm](#7-profile-instruktorów-i-firm)
8. [Rezerwacje](#8-rezerwacje)
9. [Opinie](#9-opinie)
...
| **Enterprise/Firma**    | Użytkownik posiadający Konto w roli Enterprise, który zarządza profilami instruktorów i posiada płatną subskrypcję                   |
| **Gość**                | Osoba korzystająca z Platformy bez rejestracji, która może dokonać rezerwacji gościnnej                                              |
| **Konto**               | Indywidualne konto Użytkownika na Platformie                                                                                         |
| **Usługi**              | Usługi świadczone drogą elektroniczną przez Usługodawcę za pośrednictwem Platformy                                                   |
| **Usługi Instruktora**  | Usługi treningowe, sportowe, taneczne lub inne świadczone przez Instruktora lub Firmę na rzecz Klienta, poza Platformą               |
| **Rezerwacja**          | Potwierdzenie terminu sesji/usługi pomiędzy Klientem a Instruktorem/Firmą za pośrednictwem Platformy                                 |
| **Regulamin**           | Niniejszy dokument                                                                                                                   |
| **RODO**                | Rozporządzenie Parlamentu Europejskiego i Rady (UE) 2016/679                                                                         |
| **DSA**                 | Rozporządzenie Parlamentu Europejskiego i Rady (UE) 2022/2065 (Akt o usługach cyfrowych)                                             |

---

## 2. Postanowienia ogólne

2.1. Niniejszy Regulamin określa zasady korzystania z Platformy Exercio, rodzaje i zakres Usług świadczonych drogą elektroniczną, warunki zawierania i rozwiązywania umów, tryb reklamacyjny oraz prawa i obowiązki Użytkowników.

2.2. Usługodawca świadczy Usługi zgodnie z Regulaminem i obowiązującymi przepisami prawa, w szczególności:
...
## 3. Charakter platformy — marketplace

### 3.1. Exercio jako platforma technologiczna

**Exercio jest platformą technologiczną (marketplace), która umożliwia Klientom znalezienie Instruktorów i Firm oraz dokonanie Rezerwacji. Exercio nie świadczy Usług Instruktora — nie organizuje treningów, nie prowadzi zajęć, nie świadczy usług fitness, tanecznych ani sportowych.**

### 3.2. Stosunki prawne

3.2.1. Exercio zawiera z Użytkownikiem umowę o świadczenie usług drogą elektroniczną (korzystanie z Platformy).
...
- Jakość, bezpieczeństwo ani przebieg Usług Instruktora
- Szkody osobowe lub majątkowe powstałe podczas sesji treningowych/zajęć
- Niezgodność Usług Instruktora z opisem na profilu
- Zachowanie Instruktora lub Firmy wobec Klienta
- Jakiekolwiek zdarzenia mające miejsce poza Platformą

---

## 4. Zasady korzystania z Platformy

4.1. Użytkownik zobowiązuje się korzystać z Platformy zgodnie z jej przeznaczeniem, przepisami prawa, dobrymi obyczajami oraz postanowieniami Regulaminu.
...
- Obejście zabezpieczeń Platformy
...
5.1. Rejestracja Konta jest dobrowolna i bezpłatna.

5.2. Aby założyć Konto, należy:

- Podać adres email i ustawić hasło
...
- Przeglądania profili Instruktorów i Firm
- Wyszukiwania po specjalizacji, lokalizacji, ocenach
- Dodawania Instruktorów do ulubionych
- Dokonywania Rezerwacji
- Wystawiania opinii
- Korzystania z komunikatora wewnętrznego

### 6.2. Instruktor

Instruktor ma możliwość:

- Tworzenia i zarządzania publicznym profilem
- Ustawiania dostępności i cen
- Przyjmowania i zarządzania Rezerwacjami
- Komunikacji z Klientami
- Przypisania do Firm Enterprise

### 6.3. Enterprise (Firma)

Firma ma możliwość:

- Tworzenia i zarządzania profilem firmowym
- Zarządzania instruktorami przypisanymi do Firmy
- Wykupienia płatnej subskrypcji
...
- Dokonania Rezerwacji gościnnej (bez zakładania Konta)
...
8.1. Rezerwacja dokonana za pośrednictwem Platformy stanowi **wiążące zobowiązanie** pomiędzy Klientem a Instruktorem/Firmą.
...
9.1. Opinie mogą wystawiać wyłącznie Klienci, którzy dokonali Rezerwacji i odbyli sesję.

9.2. Opinie są publiczne i widoczne dla wszystkich Użytkowników.
...
### 10.1. Płatności za usługi instruktorów

10.1.1. Płatności za Usługi Instruktora (sesje treningowe) są regulowane **bezpośrednio pomiędzy Klientem a Instruktorem/Firmą**, według zasad ustalonych przez Instruktora/Firmę.

10.1.2. Exercio nie pośredniczy w płatnościach za sesje treningowe i nie ponosi odpowiedzialności za rozliczenia pomiędzy Klientem a Instruktorem/Firmą.

### 10.2. Subskrypcje Enterprise

10.2.1. Konto Enterprise jest płatne — wymaga wykupienia subskrypcji.

10.2.2. Płatności za subskrypcje są obsługiwane przez Stripe. Exercio nie przechowuje pełnych danych kart płatniczych.

10.2.3. Subskrypcja odnawia się automatycznie, chyba że zostanie anulowana przed końcem okresu rozliczeniowego.

10.2.4. Szczegółowe zasady dotyczące subskrypcji Enterprise znajdują się w [Regulaminie Enterprise](/enterprise-terms).

---

## 11. Zwroty i reklamacje

### 11.1. Reklamacje dotyczące Usług Instruktora

**Reklamacje dotyczące Usług Instruktora (np. niezadowolenie z treningu, odwołanie sesji, zmiana terminu) należy kierować bezpośrednio do Instruktora lub Firmy, która świadczyła usługę.**

Exercio nie rozpatruje reklamacji dotyczących:

- Jakości przeprowadzonego treningu/zajęć
- Niezgodności usługi z opisem na profilu
- Odwołania sesji przez Instruktora
- Zwrotów pieniędzy za sesje
...
Exercio nie dokonuje zwrotów za Usługi Instruktora, ponieważ nie jest stroną umowy pomiędzy Klientem a Instruktorem/Firmą.
...
1. **Usługi Instruktora** — jakość, bezpieczeństwo, przebieg i skutki sesji treningowych/zajęć
2. **Szkody osobowe** — urazy, wypadki, kontuzje powstałe podczas sesji
3. **Szkody majątkowe** — zniszczenie mienia, kradzież podczas sesji
...
- Swoje usługi świadczone na rzecz Klientów
- Bezpieczeństwo sesji treningowych/zajęć
- Zgodność z przepisami prawa (w tym sanitarnymi, BHP, ubezpieczeniowymi)
...
- Przestrzeganie zasad korzystania z Platformy
- Własne bezpieczeństwo podczas sesji treningowych
