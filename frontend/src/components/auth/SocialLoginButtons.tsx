...
function saveOAuthIntent() {
  // Read intent from URL query params (set by the register page)
...
export function SocialLoginButtons() {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <a
          href={`${API_BASE_URL}/auth/google?locale=${locale}`}
          onClick={saveOAuthIntent}
        >
      ...
      >
        <a
          href={`${API_BASE_URL}/auth/facebook?locale=${locale}`}
          onClick={saveOAuthIntent}
        >
